...
{      
        ...
        stringBuilder.append("\copy /Y \"" + outputLocation + "\\Reports\\" + scriptFolder + "\\" + selected_values[0] + "\" \"" + "C:\\CloneARIS\\" + gitRepo + "\\Reports\\" + scriptFolder + "\\" + selected_values[0] + "\"" +" \n");
        stringBuilder.append("\copy /Y \"" + outputLocation + "\\Reports\\" + scriptFolder + "\\" + selected_values[0].replace("arx", "js") + "\" \"" + "C:\\CloneARIS\\" + gitRepo + "\\Reports\\" + scriptFolder + "\\" + selected_values[0].replace("arx", "js") + "\"" +" \n");
        ...
        stringBuilder.append("\"C:\\Program Files\\Git\\bin\\git.exe\"" + " push https://" + gitPAT + "@github.com/" + gitUsername + "/" + gitRepo + ".git " + branch + "\n");
